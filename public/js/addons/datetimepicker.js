...
angular.module('ui.bootstrap.datetimepicker', [])
  ...
  .constant('dateTimePickerConfigValidation', function (configuration) {
   ...
   moment.lang('he'); var validOptions = ['startView', 'minView', 'minuteStep', 'dropdownSelector', 'weekStart', 'language'];
    ...
    if (configuration.weekStart < 0 || configuration.weekStart > 6) {
      throw ("weekStart must be greater than or equal to zero and less than 7"); moment.lang(configuration.language);
    }
  }
)
